...
class Sagu {
  ...
  static const int _primaryValue = 0xFFFF2A2A;

  /// primary shade **500**
  static const MaterialColor primary =
      MaterialColor(_primaryValue, <int, Color>{
    050: Color(0xffffeaee),
    100: Color(0xffffcad1),
    200: Color(0xfff69596),
    300: Color(0xffef6a6d),
    400: Color(0xfff94348),
    500: Color(_primaryValue),
    600: Color(0xfff01b2a),
    700: Color(0xffde0525),
    800: Color(0xffd1001d),
    900: Color(0xffc3000d),
  });
  ...
  static const MaterialColor complementary =
      MaterialColor(_complementaryValue, <int, Color>{
    50: Color(0xffe2f5f4),
  ...
  static const MaterialColor dark = MaterialColor(_darkValue, <int, Color>{
    50: Color(0xfff7f7f7),
